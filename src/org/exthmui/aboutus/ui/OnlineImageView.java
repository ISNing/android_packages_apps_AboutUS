...
package org.exthmui.aboutus.ui;
...
public class OnlineImageView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    private OnlineImageViewCallback mCallback;
    ...
    public OnlineImageViewCallback getCallback() {
        return mCallback;
    }

    public void setCallback(OnlineImageViewCallback callback) {
        mCallback = callback;
    }

    public interface OnlineImageViewCallback {
        void OnSuccess();
